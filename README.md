...
| [DL3062](https://github.com/hadolint/hadolint/wiki/DL3062)   | Warning          | Install only essential dependencies. Instead of `npm ci/install` use `npm --production ci/install`                                                  |
